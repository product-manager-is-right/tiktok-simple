...
func (VideoService VideoFeedServiceImpl) GetVideoByLatestTime(lastTime time.Time) ([]vo.Video, time.Time, error) {
...
func (videoService *VideoFeedServiceImpl) CopyVideoInfo(videos *[]vo.Video, myVideo *[]model.TableVideo) error {
